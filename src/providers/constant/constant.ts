...
export class ConstantProvider {
  ...
  public upload_url: string ='https://apps.abacusdesk.com/dishagypsum/dd_api/app/uploads/';
    ...
    // Testing url
    // public rootUrl: string = 'https://devcrm.abacusdesk.com/dishagypsum/dd_api/';  
    // public server_url: string = this.rootUrl + 'index.php/app/';
    // public upload_url: string ='https://devcrm.abacusdesk.com/dishagypsum/dd_api/app/uploads/';
